...
Pipeline role
-------------
Per-speaker breakdown of the surprisal-augmented duration
regression for the post-recension dataset. Loads
``../podaci/training_data.csv``, sweeps the surprisal exponent
``k`` via :func:`my_functions.inf_k_model` and per speaker
reports the delta log-likelihood improvement over the
surprisal-free baseline via :func:`my_functions.akaike_for_column`,
quantifying how much each individual speaker's spoken word
