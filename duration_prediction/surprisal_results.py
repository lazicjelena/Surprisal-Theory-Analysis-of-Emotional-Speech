...
def calculate_aic(real_values, results, k):
    ...
    :func:`calculate_log_Likelihood`, then the per-point AIC is
    returned together with the mean and standard deviation of the
    log-likelihood across all samples. Only the mean and standard
    deviation are used downstream by :func:`akaike_for_column`.
