...
Pipeline role
-------------
Per-word breakdown of the transformer-surprisal regression
...
distinct word, computes the delta log-likelihood improvement
over the surprisal-free baseline. The resulting per-word table
shows which words gain the most prediction quality from the
