...
Pipeline role
-------------
Per-sentence-position breakdown of the transformer-surprisal
regression analysis. For one chosen model (BERTic / BERT / GPT)
the script loads
...
position-in-sentence index, computes the delta log-likelihood
improvement over the surprisal-free baseline. The resulting
